package com.marvel.developer.main.data
...
val characterData by lazy {
    CharacterData(offset = 0, total = 1504, characters = mutableListOf(character, favoriteCharacter))
}
